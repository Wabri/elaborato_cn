...
% forma di Newton (rispetto alla base di Newton) nel caso di ascisse di Hermite.
%
% Input:
% -f: vettore contenente i valori della funzione e la derivata prima
% sulle ascisse di interpolazione, nella forma [f0, f'0, f1, f'1, ..., fn, f'n]
% 
% -x: vettore contenente le 2n+2 ascisse di interpolazione di Hermite.
%
% Output:
